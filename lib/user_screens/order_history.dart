...
class _OrderHistoryState extends State<OrderHistory> {
  ...
  @override
  void initState() {
    _data = appMethods.getOrderHistorybyId(userID);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Order history'), actions: <Widget>[
        Padding(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Text(document.data[productVariation],
                      style: TextStyle(

...
import 'package:shopifyapp/adminScreens/adminHome.dart';
import 'package:shopifyapp/tools/appData.dart';

import 'package:shopifyapp/tools/app_methods.dart';
import 'package:shopifyapp/tools/app_tools.dart';
import 'package:shopifyapp/tools/firebase_methods.dart';
import 'package:shopifyapp/user_screens/categories.dart';
import 'package:shopifyapp/user_screens/favorites.dart';
import 'package:shopifyapp/user_screens/login.dart';

import 'package:shopifyapp/user_screens/cart.dart';

import 'package:shopifyapp/user_screens/order_history.dart';
import 'package:shopifyapp/user_screens/profile_settings.dart';

import 'package:shopifyapp/user_screens/address.dart';
import 'package:shopifyapp/user_screens/about.dart';

import 'package:shopifyapp/user_screens/item_details.dart';

import 'package:shopifyapp/user_screens/search.dart';
...
class _MyState extends State<MyHomePage> {
  ...
  Future _alertDialogue(
      BuildContext context, String message, String header) async {
    showDialog(
        context: context,

...
class _AddProductState extends State<AddProduct> {
  ...
  addNewProduct() async {
    ...
    if (productTitleController.text == "" ||
        productTitleController.text.length < 5) {
      showSnackBar(
          message:
              "Product title cannot be empty or product title is too short",
          key: scaffoldKey);
      return;
    }
    ...
    if (productDescController.text == "" ||
        productDescController.text.length < 10) {
      showSnackBar(
          message:
              "Product description cannot be empty or product description is too short",
          key: scaffoldKey);
      return;
    }
